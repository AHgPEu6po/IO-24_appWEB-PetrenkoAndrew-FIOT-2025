    ...
    <div className='add'>
      <form className="flex-col" onSubmit={onSubmitHandler}>
        ...
        <div className="add-product-description flex-col">
            <p>Опис Страви</p>
            <textarea onChange={onChangeHandler} value={data.description} name="description" rows="6" required/>
        </div>
        <div className="add-category-price">
            ...
            <div className="add-price flex-col">
                <p>Ціна страви</p>
                <input onChange={onChangeHandler} value={data.price} type="numder" name='price' required/>
            </div>
        </div>
